...
int main() {
    ...
    usleep(800000); // pause to allow users to read the welcome message
    ...
    while (1) { // main prog loop
        ...
        switch (choice) {
            ...
            case 11: { // exit the program
                printf("\t\t\t\033[1;32;40mThanks for using the Student Management System!!!\033[0m\n"); 
                printf("\t\t\033[1;40mCreated by Alakparov Shahin, Alizada Fidan, Aliyeva Nazrin\033[0m\n"); // credits
                printf("\t\t\t\t\033[1;40mExiting program...\033[0m\n"); 
